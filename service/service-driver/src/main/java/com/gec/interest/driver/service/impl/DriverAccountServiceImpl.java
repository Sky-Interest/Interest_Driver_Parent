...
import com.gec.interest.driver.mapper.DriverAccountDetailMapper;
import com.gec.interest.driver.mapper.DriverAccountMapper;
import com.gec.interest.driver.service.DriverAccountService;
import com.gec.interest.model.entity.driver.DriverAccount;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.gec.interest.model.entity.driver.DriverAccountDetail;
...
public class DriverAccountServiceImpl extends ServiceImpl<DriverAccountMapper, DriverAccount> implements DriverAccountService {
    ...
    public Boolean transfer(TransferForm transferForm) {
        //去重
        long count = driverAccountDetailMapper.selectCount(new LambdaQueryWrapper<DriverAccountDetail>().
