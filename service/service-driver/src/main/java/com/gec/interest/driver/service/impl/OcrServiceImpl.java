...
public class OcrServiceImpl implements OcrService {
     ...
     *
     *
     * @SneakyThrows 是 Lombok 库中的一个注解，主要用于简化异常处理。它可以用于方法上，使得你在方法中抛出受检异常时，不需要显式地捕获或声明这些异常。
     *
     * 具体来说，当你在一个方法中使用 @SneakyThrows 注解时，Lombok 会自动将任何受检异常（checked exception）转化为运行时异常（unchecked exception）
     * @param file
     * @return
     */
    @SneakyThrows
