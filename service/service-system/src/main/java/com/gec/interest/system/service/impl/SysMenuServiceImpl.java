...
import com.gec.interest.model.entity.system.SysRoleMenu;
import com.gec.interest.model.vo.system.AssginMenuVo;
import com.gec.interest.model.vo.system.MetaVo;
import com.gec.interest.model.vo.system.RouterVo;
import com.gec.interest.system.helper.MenuHelper;
import com.gec.interest.system.mapper.SysMenuMapper;
import com.gec.interest.system.mapper.SysRoleMenuMapper;
import com.gec.interest.system.service.SysMenuService;
...
public class SysMenuServiceImpl extends ServiceImpl<SysMenuMapper, SysMenu> implements SysMenuService {
    ...
    public boolean removeById(Serializable id) {
        ...
        if (count > 0) {
            throw new interestException(ResultCodeEnum.NODE_ERROR);
        }
        ...
        for (SysMenu menu : menus) {
            ...
            if(menu.getType().intValue() == 1) {
                ...
                for (SysMenu hiddenMenu : hiddenMenuList) {
                    ...
                    Boolean isHide1 = hiddenMenu.getIsHide().intValue() == 1 ? true : false;
